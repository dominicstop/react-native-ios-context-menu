...
type RNIContextMenuButtonNativeComponentBaseProps = 
  Omit<RNIContextMenuButtonNativeComponentProps, keyof (ViewProps & SharedViewEvents)>

export type RNIContextMenuNativeViewBaseProps = RemapObject<RNIContextMenuButtonNativeComponentBaseProps, {
